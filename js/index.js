...
L.tileLayer(
  "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}", {
    ...
    accessToken: "pk.eyJ1Ijoic2FpZGEyNSIsImEiOiJja2xuem4wdnUwbzBsMndwNGNyNWxwY2wwIn0.5fLWNX8N2uwiKwyjY_4vog",
  }
).addTo(map);
...
let launch_location = [{
    name: "Kennedy Space Launch",
    coordinates: [28.6272, -80.6209]
  },
  {
